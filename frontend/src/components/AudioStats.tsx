...
export default function AudioStats() {
  ...
  if (!isConnected || !audioMetrics) return null
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {/* Quality Score (Large) */}
        <div className="bg-slate-950/30 border border-white/5 rounded-lg p-3 relative overflow-hidden group">
          ...
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="text-right">
              <span className={`text-2xl font-mono font-bold ${getQualityColor(audioMetrics.quality_score)}`}>{audioMetrics.quality_score}</span>
